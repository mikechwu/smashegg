 ...
 * the Simplified Chinese self-label while the app shows zh-Hant), which is why these are constants
 * here and NOT translation keys — putting them in the locale JSON files is
 * what produced the Simplified-Chinese-label-under-zh-Hant drift this replaces (m3h). */
